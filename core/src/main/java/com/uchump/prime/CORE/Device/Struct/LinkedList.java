...
public class LinkedList<E> extends ArrayList<E> implements Cloneable, Deque<E>, java.io.Serializable, List<E> {
	...
	/*
	 * void dataStructureInvariants() { assert (size == 0) ? (first == null && last
	 * == null) : (first.prev == null && last.next == null); }
	 */
