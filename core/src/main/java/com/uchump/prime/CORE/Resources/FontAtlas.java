package com.uchump.prime.CORE.Resources;
...
public class FontAtlas {
	...
	public FontAtlas() {
		...
		this.ReferenceCache = new ArrayList<FontReference>();
		this.FontCache = new HashMap<BitmapFont, Integer>();
		...
		for (FileHandle h : fileList) {
			...
			this.ReferenceCache.add(newRef);
		}
		...
		for (FontReference r : refList) {
			...
			this.FontCache.put(genF, r.size);
		}
