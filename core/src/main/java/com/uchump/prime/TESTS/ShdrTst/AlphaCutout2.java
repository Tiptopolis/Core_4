...
public class AlphaCutout2 implements iApplet{
	...
	public void create() {
		...
		Vector3 xVect = new Vector3((160f / 255f), (130f / 255f), (90f / 255f)); //desired color to mask over
		...
		shader.setUniformf("u_color", xVect);
